...
// find a field by name in a Skeletor' schema
SkeleUtils.GlobalUtilities.findFieldInSchema = function(schema, fieldName) {
    return schema.fields.find(function(fieldSchema, index) {
